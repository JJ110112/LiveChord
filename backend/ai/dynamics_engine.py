...
# 整體偏提前 (anticipation)，避免 MIDI 聽起來拖拍
# 強拍 (beat 1/3) 提前 25~30ms，弱拍也微提前 5~10ms
HUMANIZE_TIMING = {
    "4/4": [-0.030, -0.005, -0.020, -0.008],
    "3/4": [-0.030, -0.005, -0.010],
    "2/4": [-0.030, -0.005],
    "6/8": [-0.025, -0.005, -0.008, -0.020, -0.005, -0.008],
}
